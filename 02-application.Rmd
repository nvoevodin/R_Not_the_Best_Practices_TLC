...
Now, let’s simulate a problem. Let’s see what happens if your Rstudio session freezes or your computer just crashes. So, lets add another line of code to our script and see what happens if we forget to save it and windows fucks up again. Go ahead and add this line of code right under the first one:
...
::: {.infobox .note data-latex="{note}"}
It happened to me a few times with excel and word, and I did not have auto-save enabled and I lost hours of my life rewriting shit, because windows decided to fuck me.
:::
...
::: {.infobox .caution data-latex="{caution}"}
Delete that shit and reinstall. Proven method, patented by myself.
:::
...
To make sure you don’t sit there for too long, like I did, figuring that shit out, I’ll teach you a few troubleshooting tricks. Let’s come back to uninstalling our packages. Run the following:
